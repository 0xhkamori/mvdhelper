...
addEventHandler("onWindowMessage", function (msg, wparam, lparam)
    ...
    if msg == wm.WM_XBUTTONUP then
        if wparam == 65536 then
           wparam = 0x05
        end
        if wparam == 131072 then
           wparam = 0x06
        end
    end
    ...
    if msg == wm.WM_KEYDOWN or msg == wm.WM_SYSKEYDOWN or (msg == wm.WM_XBUTTONDOWN and (wparam == 0x05 or wparam == 0x06)) then
    ...
    elseif msg == wm.WM_KEYUP or msg == wm.WM_SYSKEYUP or (msg == wm.WM_XBUTTONUP and (wparam == 0x05 or wparam == 0x06)) then
        local num = getKeyNumber(wparam)
        if num > -1 then
            tKeys[num] = nil
        end
